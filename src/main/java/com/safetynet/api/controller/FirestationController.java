...
public class FirestationController {
	...
	@ResponseStatus(HttpStatus.OK)
	public FirestationCoveragePersonWithCounting getListFirestationCoveragePerson(
	...
	@ResponseStatus(HttpStatus.OK)
	public PersonsInfoWithFirestation getListPersonsAndNumberFirestationByAddress(
	...
	@ResponseStatus(HttpStatus.OK)
	public List<FirestationPersonAtAddress> getListHomesByStation(
			@RequestParam("stationNumber") List<String> stations) {
